...
namespace WebApplication5.Repository
{
    public class EpisodeRepository : IEpisodeRepository
    {
        ...
        public async Task<IEnumerable<Episode>> GetAllEpisodesBySeason(string animeName, int seasonId) => await _dataContext.Episodes.Where(e => e.SeasonNumber == seasonId && e.Season.Anime.AnimeName == animeName)
