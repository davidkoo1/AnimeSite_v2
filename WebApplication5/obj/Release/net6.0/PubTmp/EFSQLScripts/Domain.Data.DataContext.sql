...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230831142505_Init')
BEGIN
...
BEGIN
    CREATE TABLE [Animes] (
        ...
        CONSTRAINT [FK_Animes_Editors_EditorId] FOREIGN KEY ([EditorId]) REFERENCES [Editors] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    ...
    VALUES (N'20230831142505_Init', N'7.0.9');
END;
GO
